        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_align_center tm_mb20">
            ...
            <div class="tm_invoice_right tm_text_right">
              ...
              <div class="tm_primary_color tm_f50 tm_text_uppercase">@if($purchase->status == "FAILED" || $purchase->status == "RETURNED" || $purchase->status == "CANCELLED") <span style="color: red;">NOT VALID</span> @endif</div>
            </div>
          </div>
          <div class="tm_invoice_info tm_mb20">
            <div class="tm_invoice_seperator tm_gray_bg"></div>
            <div class="tm_invoice_info_list">
              <p class="tm_invoice_number tm_m0">Invoice No: <b class="tm_primary_color">{{ $purchase->transaction_id }}</b></p>
          ...
          <div class="tm_table tm_style1 tm_mb30">
            ...
            <div class="tm_invoice_footer">
              <div class="tm_left_footer">
                ...
                <p class="tm_m0">Payment Method : {{ $purchase->payment_method }} <br>Amount: $ {{ $purchase->amount }}</p>
              </div>
